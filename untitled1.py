...
def generate_subkeys(key):
    ...
    for i in range(16):
        ...
        # divide the subkey into two equal parts L and R
        subkey_L = subkey[:28]
        subkey_R = subkey[28:]

        subkeys.append((subkey_L, subkey_R))

    return subkeys

key = "133457799BBCDFF1"
subkeys = generate_subkeys(key)
for i, (subkey_L, subkey_R) in enumerate(subkeys):
    print("Subkey {}:\n L={},\n R={}".format(i+1, subkey_L, subkey_R))
